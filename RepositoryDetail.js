...
var CommitsList = require('./CommitsList');
        ...
        return(
            <View style={styles.container}> 
                ...
                <View style={{
                    ...
                    <View>
                        <Image source={{uri: this.state.data.owner.avatar_url}}
                            style={{height: 90, width: 90, borderRadius: 45}}></Image>
                    </View>
                    <View style={{
                        flex: 1,
                        ...
                        <Text style={{marginTop: 5}}>Created by <Text style={{fontWeight: '800'}}>{this.state.data.owner.login}</Text></Text>
                        <Text style={{
                            color:'blue',
                            marginTop: 5}}
                            onPress={() => Linking.openURL(this.state.data.html_url)}>
                            Visit Repo
                        </Text>
                        <View style={{
                            flexDirection: 'row',
                            ...
                            <View style={styles.repoCell} >
                                ...
                                <Text style={styles.repoCellLabel}>
                                    {this.state.data.stargazers_count}
                                </Text>
                            </View>
                            <View style={styles.repoCell} >
                ...
                <Swiper style={styles.wrapper} loop={false} showsPagination={true}>
                    <CommitsList full_name={this.state.data.full_name}/>
                    <IssuesList full_name={this.state.data.full_name}/>
                </Swiper>
            </View>
        );
    }
